...
import mostwanted.domain.dtos.race_import.EntryImportDto;
import mostwanted.domain.dtos.race_import.RaceImportDto;
import mostwanted.domain.dtos.race_import.RaceImportRootDto;
...
public class RaceServiceImpl implements RaceService {
    ...
    public String importRaces() throws JAXBException, IOException {
        ...
        RaceImportRootDto raceImportRootDto = this.xmlParser.parseXml(RaceImportRootDto.class, "C:\\AleksandarUser\\Programming\\GitHubRepositories\\Software-University-Databases-Frameworks-Hibernate-and-Spring-Data\\Exams\\MostWanted\\src\\main\\resources\\files\\races.xml");
