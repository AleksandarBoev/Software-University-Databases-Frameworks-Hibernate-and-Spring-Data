...
import mostwanted.domain.dtos.import_dtos.RaceEntryImportDto;
import mostwanted.domain.dtos.import_dtos.RaceEntryRootDto;
...
public class RaceEntryServiceImpl implements RaceEntryService {
    ...
    private final static String RACE_ENTRIES_XML_FILE_PATH = "C:\\AleksandarUser\\Programming\\GitHubRepositories\\Software-University-Databases-Frameworks-Hibernate-and-Spring-Data\\Exams\\MostWanted\\src\\main\\resources\\files\\race-entries.xml";
    ...
    public String importRaceEntries() throws JAXBException, IOException {
        ...
        RaceEntryRootDto raceEntryImportRootDto = this.xmlParser
                .parseXml(RaceEntryRootDto.class, RACE_ENTRIES_XML_FILE_PATH);

        Arrays.stream(raceEntryImportRootDto.getRaceEntryImportDtos()).forEach(raceEntryImportDto -> {
            Racer racerEntity = this.racerRepository.findRacerByName(raceEntryImportDto.getRacer());
